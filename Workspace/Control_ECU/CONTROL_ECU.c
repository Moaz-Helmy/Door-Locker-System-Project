 ...
 *
 * Description: This application uses GPIO, Timer1, and PWM drivers to control
 * 				the activation and deactivation of the buzzer along with controlling
 * 				the rotation of the DC-Motor. It also uses UART, and I2C drivers
 * 				to communicate with both the HMI ECU and the external EEPROM.
 *
 * Author:		Moaz Mohamed
 *
 * Date: 		28/10/2022
